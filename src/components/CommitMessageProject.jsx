    ...
    <div className="project-detail">
      ...
      <section className="project-section alt-bg">
        <div className="project-container">
          ...
          <p className="project-challenge">How can we make Git feel effortless?</p>

          <h2 className="project-section-title">Solution</h2>
          <p className="project-solution-intro">Introduce AI natively in the existing developer work flows to remove tedium</p>
          <p className="project-text">
