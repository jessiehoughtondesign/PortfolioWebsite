    ...
    <div className="project-detail">
      ...
      <section className="project-section alt-bg">
        <div className="project-container">
          ...
          <p className="project-challenge">How can we deliver the best Copilot Chat experiences, tailored to each team's preferences?</p>

          <h2 className="project-section-title">Solution</h2>
          <p className="project-text">
            <strong>As users prompt, automatically detect and document team preferences to fuel more customized, accurate future responses</strong>
          </p>
          <p className="project-text">
